...
import logging
import uuid
from sqlalchemy import or_  # Import the or_ function for combining search conditions
...
def dashboard():
    ...
    # Apply search filter
    if search_query:
        # Use SQLAlchemy's or_ to combine multiple search conditions
    ...
    return render_template('dashboard.html', 
                           ...
                           current_search=search_query, # Pass the search query to the template
